      ...
      <div class="row">
        <div class="col-md-16">
          <div class="form_container">
            ...
            <form id="Login" action="enviarcomentario.php" method="post">
              <div>
              ...
              <div>
                <input id="comentario" name="comentario" type="text" class="message-box" placeholder="Comentario" />
              </div>
                <button name="guardar" id="submit">
                  Agregar
                </button>
            </form>
          </div>
...
<br><br>
<center><h2>Comentarios</h2></center><br>
      ...
      $resultado=mysqli_query($conexion, 'SELECT * FROM comentarios ORDER BY creado DESC');
    ...
    <center>
      <th class="cuadro"><b>usuario :</b> <?php echo($comentario->usuario); ?></th><br>
      <th class="cuadro"><b>correo :</b> <?php echo($comentario->correo); ?></th><br>
      <th class="cuadro"><b>creado :</b> <?php echo($comentario->creado); ?></th><br>
      <th class="cuadro"><b>comentario :</b> <?php echo($comentario->comentario); ?></th><br><br>
    </center>
